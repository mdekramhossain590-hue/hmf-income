          ...
          <div className="space-y-3 mt-4 animate-in fade-in slide-in-from-top-2 duration-300 ease-out">
            <div className="bg-white dark:bg-slate-900/50 p-3 rounded-xl flex justify-between items-center ring-1 ring-slate-100 dark:ring-slate-700/50">
              ...
              {loading ? (
                ...
                <span className="font-display font-semibold text-slate-800 dark:text-white text-xl tracking-tight">
                  ৳{" "}
                  {(profile?.balances?.main || 0).toLocaleString("en-IN", {
            ...
            <div className="flex gap-3">
              <div className="flex-1 bg-white dark:bg-slate-900/50 p-3 rounded-xl flex flex-col ring-1 ring-slate-100 dark:ring-slate-700/50">
                ...
                {loading ? (
                  ...
                  <span className="font-display font-semibold text-slate-800 dark:text-white text-xl tracking-tight mt-1">
                    ৳{" "}
                    {(profile?.balances?.bonus || 0).toLocaleString("en-IN", {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2,
                    })}
                  </span>
              ...
              <div className="flex-1 bg-white dark:bg-slate-900/50 p-3 rounded-xl flex flex-col ring-1 ring-slate-100 dark:ring-slate-700/50">
                ...
                {loading ? (
                  ...
                  <span className="font-display font-semibold text-slate-800 dark:text-white text-xl tracking-tight mt-1">
                    ৳{" "}
                    {(profile?.balances?.referral || 0).toLocaleString(
                      "en-IN",
              ...
              <div className="flex-1 bg-white dark:bg-slate-900/50 p-3 rounded-xl flex flex-col ring-1 ring-slate-100 dark:ring-slate-700/50">
                ...
                {loading ? (
                  ...
                  <span className="font-display font-semibold text-slate-800 dark:text-white text-xl tracking-tight mt-1">
                    ৳{" "}
                    {(profile?.balances?.gift || 0).toLocaleString(
                      "en-IN",
                      { minimumFractionDigits: 2, maximumFractionDigits: 2 },
                    )}
                  </span>
            ...
            <div className="pt-3 border-t border-slate-100 dark:border-slate-700/50 mt-4 outline-none">
              <p className="text-[11px] font-bold text-slate-400 dark:text-slate-500 mb-3 uppercase tracking-widest pl-1">
                Task Balances
              </p>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[
                  ...
                  return (
                    <div
                      key={taskName}
                      className="bg-slate-50 dark:bg-slate-900/30 p-3 rounded-xl border border-transparent dark:border-slate-700/30 flex flex-col"
                    >
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 truncate mb-1 uppercase font-medium tracking-wider">
                        {taskName}
                      </span>
                      {loading ? (
                        <div className="h-4 w-12 bg-slate-200 dark:bg-slate-700 rounded animate-pulse"></div>
                      ) : showBalance ? (
                        <span className="text-[14px] font-display font-semibold text-slate-800 dark:text-slate-200">
                          ৳{" "}
